...
(function($){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['parent','pageRank','recherche','motcle']) >=0 ){
  ...
  */
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"Moteur de recherche":    {color:"red", shape:"dot", alpha:1, borderColor: "#ABCFD6"}, 
             demos:         {color:CLR.branch, shape:"dot", alpha:1, borderWidth: 3, borderColor: "#ABCFD6"}, 
             docs:          {color:CLR.branch, shape:"dot", alpha:1, borderWidth: 3, borderColor: "#ABCFD6"}, 
             code:          {color:CLR.branch, shape:"dot", alpha:1, borderWidth: 3, borderColor: "#ABCFD6"}
            },
      edges:{
        "Moteur de recherche":{
          demos:{length:.8},
    ...
    sys.parameters({stiffness:900, repulsion:1500, gravity:true, dt:0.015})
